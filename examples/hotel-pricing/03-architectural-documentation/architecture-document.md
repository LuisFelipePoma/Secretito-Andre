...
The selected context, domain, container, component, runtime, event, and deployment views answer commercial, implementation, integration, security, and operations questions. No additional 4+1 package is required.

## 6. Architecture Views

The following domain, container, component, sequence, event, and deployment sections are the selected views. Each Mermaid diagram defines its elements and relations in labels and surrounding text.
...
## 11. Interfaces And Runtime Behavior
...
## 14. Governance And Agent Guidance
...
## 19. Quality, Security, Data And Operations
...
## 21. Risks, Assumptions And Technical Debt

CMS delivery limits, projection lag, authorization scope, and the legacy replacement sequence remain architect-owned review triggers.
